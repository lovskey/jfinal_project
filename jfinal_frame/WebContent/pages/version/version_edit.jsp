...
<title>修改版本信息</title>
<script type="text/javascript" src="<%=request.getContextPath()%>/pages/version/version_edit.js"></script>
		...
		<form id="form" method="post" style="padding-top: 30px;padding-left: 30px;">
			...
			<table>
				<tr>
					...
					<td width="200px">
						<input id="APP_TYPE" name="APP_TYPE" class="easyui-combobox" data-options="required:true,editable:false" style="width: 180px;" />
					</td>
					<td width="100px">
					</td>
					<td width="200px">
				...
				<tr>
					...
					<td width="200px">
						<input id="OUTER_VERSION" name="OUTER_VERSION" type="text" style="width: 180px;" 
							class="easyui-validatebox" data-options="required:true" validType="length[1,12]" />
					</td>
					<td width="100px">
						<label>内部版本号：</label>
					</td>
					<td width="200px">
						<input id="INNER_VERSION" name="INNER_VERSION" class="easyui-numberbox" style="width: 180px;" 
							data-options="min:1,precision:0,max:1000,required:true" />
					</td>
				</tr>
				<tr>
					<td width="100px">
					...
					<td width="500px" colspan="3">
						<textarea id="APP_URL" name="APP_URL" type="text" style="width: 488px;height: 80px;resize: none;" maxlength="200"></textarea>
					</td>
				</tr>
				<tr>
					<td width="100px">
					...
					<td width="500px" colspan="3">
						<textarea id="DESCRIPTION" name="DESCRIPTION" type="text" style="width: 488px;height: 120px;resize: none;" maxlength="400"></textarea>
					</td>
					</td>
				</tr>
				<tr>
