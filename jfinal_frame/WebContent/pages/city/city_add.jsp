...
<title>新增城市</title>
<script type="text/javascript" src="<%=request.getContextPath()%>/pages/city/city_add.js"></script>
<style type="text/css">
</style>
		...
		<form id="form" method="post" style="padding-top: 30px;padding-left: 80px;">
			<table>
				<tr>
					...
					<td>
						<input id="pValue" name="pValue" type="text" style="width:200px" disabled="disabled" />
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input id="pText" name="pText" type="text" style="width:200px" disabled="disabled" />
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input id="cValue" name="cValue" type="text" style="width: 200px" maxlength="8"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input id="cText" name="cText" type="text" style="width: 200px" maxlength="16"/>
					</td>
				</tr>
				<tr>
					<td></td>
