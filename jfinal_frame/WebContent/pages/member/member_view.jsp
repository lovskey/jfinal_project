		...
		<form id="form" method="post" style="padding-top: 30px;padding-left: 30px;">
			...
			<table>
				<tr>
					...
					<td width="500px">
						<input id="USER_PHONE" name="USER_PHONE" type="text" style="width: 480px;" maxlength="11" disabled="true" />
					</td>
				</tr>
				<tr>
					<td width="100px">
					...
					<td width="500px">
						<input id="USER_NICKNAME" name="USER_NICKNAME" type="text" style="width: 480px;" maxlength="20" disabled="true" />
					</td>
				</tr>
				<tr>
					<td width="100px">
				...
				<tr>
					...
					<td width="500px">
						<input id="USER_SIGN" name="USER_SIGN" maxlength="120" style="width: 480px;" disabled="true" />
					</td>
				</tr>
				<tr>
					<td width="100px">
				...
				<tr>
					...
					<td width="500px">
						<input id="FREEZE_REMARK" name="FREEZE_REMARK" maxlength="120" style="width: 480px;" disabled="true" />
					</td>
				</tr>
				<tr>
					<td></td>				
